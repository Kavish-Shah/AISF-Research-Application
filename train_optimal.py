...
models_dir = "models/PPO_Ablation"
log_dir = "logs"
video_dir = "videos"
...
model.learn(total_timesteps=300000, tb_log_name="04_ablation_small_net" ) 
print("Training finished.")

model.save(f"{models_dir}/ablation_model")
